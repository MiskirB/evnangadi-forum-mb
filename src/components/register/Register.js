    ...
    <>
      <section className="mt-8">
        ...
        <p className="text-neutral-600 text-sm text-center mb-3">
          ...
          <Link onClick={() => dispatch({ type: "login" })} className="text-amber-500">
            Sign in
          </Link>
        </p>
        <form className="ml-6" onSubmit={handleSubmit}>
          ...
          <div>
            <button className="border w-11/12 py-2 pl-1 mb-3 text-white bg-blue-600 rounded-md" type="submit">
              Agree and Join
            </button>
          </div>
        </form>
        <p className="text-xs text-center mt-4 mb-2">
          I agree to the <span className="text-amber-500">privacy policy</span> and <span className="text-amber-500">terms of service</span>
        </p>
        <Link onClick={() => dispatch({ type: "login" })} className="text-amber-500 text-xs ml-36 mb-6 text-center">
          Already have an account?
        </Link>
      </section>
    </>
